...
export const CustomAccordion = forwardRef<HTMLDivElement, CustomAccordionProps>(
  ({ title, title_text, text, icon }, ref) => {
    ...
    return (
      <div ref={ref} className={styles.hardwareAccordion}>
...
export const MCustomAccordion = motion(CustomAccordion)
